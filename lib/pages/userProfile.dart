          ...
          children: [
            ...
            const CircleAvatar(
              ...
              backgroundImage: AssetImage(
                  'assets/profile_image.png'), // Add your image asset
            ),
            ...
            _buildProfileButton('Favorite', Icons.favorite),
            _buildProfileButton('Appointment History', Icons.description),
            _buildProfileButton('Medical History', Icons.history),
            _buildProfileButton('Help and Support', Icons.help),
            const SizedBox(height: 24),
            ElevatedButton(
              onPressed: () {
